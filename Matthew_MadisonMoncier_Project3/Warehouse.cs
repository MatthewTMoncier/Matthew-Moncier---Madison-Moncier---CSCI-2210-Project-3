...
namespace Matthew_MadisonMoncier_Project3
{
    internal class Warehouse
    {
        ...
        {
            var str = $"{time}, {truck._driver}, {truck._deliveryCompany}, {crate._id}, {String.Format("{0:0.00}",crate._price)}, {scenario}";
            ...
            {
                Console.WriteLine("There was an error involving the CSV file. Please try again.");
            }
